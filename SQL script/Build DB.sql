...
insert into web_project_g14.Events(is_personal,event_type,event_name,status,event_dt,place,image_src,short_description,long_description,max_occupancy)
 values ('0','','Chocolate Workshop','Open','2022-03-19 00:00:00','Office','/pages/events/static/img/Chocolate1.jpg','The chocolate workshop is a great activity for kids and adults, and is suitable for all ages.','The chocolate workshop is a great activity for kids and adults, and is suitable for all ages. The tour begins with a 15 minute video about the origins of chocolate, and proceeds to a workshop room. At the workshops, each participant can choose their desired workshop, and still work around the same table.',3);
insert into web_project_g14.Events(is_personal,event_type,event_name,status,event_dt,place,image_src,short_description,long_description,max_occupancy)
 values ('0','','Home Made Marshmellos','Open','2022-03-21 00:00:00','Office','/pages/events/static/img/Company_Happy_Hour.jpg','We are bringing the bakery to you. you can get your cakes and chocolates where ever you want.','We are bringing the bakery to you, now offering contactless delivery nationwide so you can get your cakes and chocolates were ever you want to.',50);
insert into web_project_g14.Events(is_personal,event_type,event_name,status,event_dt,place,image_src,short_description,long_description,max_occupancy)
 values ('0','','Make your waffle','Open','2022-03-22 00:00:00','Office','/pages/events/static/img/Waffle_Event.jpg','Our classic workshop runs almost every day in the year! It lasts about 90 minutes.','Our classic workshop runs almost every week in the year! It lasts about 90 minutes, no previous cooking experience is needed and you can make as many waffles as you can eat!',50);
